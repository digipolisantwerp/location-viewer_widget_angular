...
export class NgxLocationViewerComponent implements OnInit, OnChanges, OnDestroy {
                ...
                forkJoin([
                    ...
                    .subscribe(([layerInfo, legend]) => {
                        ...
                        this.leafletMap.addOperationalLayer(
                            ...
                            this.operationalLayerOptions.tooltipField ? this.operationalLayerOptions.tooltipField : layerInfo.displayField,
                        );
    ...
    private initiateFilterLayers() {
        ...
        if (this.filterLayers) {
            this.leafletMap.setVisibilityFilterLayer(false);
            this.filterLayers$ = from(this.filterLayers).pipe(
            ...
            switch (e.shape) {
                ...
                case Shapes.Marker: {
                    this.geoApiService
                        ...
                        .pipe(take(1))
                        .subscribe((x) => {
                            this.whatIsHereSelected.emit(x.addressDetail[0] || null);
